...
export default class News extends Component {
  ...
  async updatenews(pageNo){
    const url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1d8cb581d65946348993fa6beabffd5e&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  constructor(props) {
    ...
    document.title = `${this.capitalizeFirstletter(props.category)} - NEWSSTRA`;
  }
  render() {
    return (
      <div className="container my-3">
        <h1 className="text-center " style={{margin:'30px'}}>NEWSSTRA Top {this.capitalizeFirstletter(this.props.category)} Headlines </h1>
